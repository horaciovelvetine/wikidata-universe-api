...
public class WikidataServiceManager {
   ...
   */
  public Optional<Err> fetchIncompleteDataTask(ClientRequest clientRequest) {
    //todo
    while (!clientRequest.graph().allDataFetched()) {
   ...
   * @param ClientRequest
   * @return an Err(or) if one was encountered carrying out task
   */
